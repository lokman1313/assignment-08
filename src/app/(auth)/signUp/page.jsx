...
if (error) {
  ...
  <input type="text" className="input" placeholder="Enter Your Image URL" {...register("image")} />
...
<p className="text-center">Allready have an account ? <span className="text-blue-400"><Link href={"/login"}>Login</Link></span></p>
        </fieldset>
            </form>
        </div>
    );
