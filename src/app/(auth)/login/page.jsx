...
if (error) {
  ...
  <span 
     className="absolute right-3 top-44 text-lg"
...
<p className="text-center mt-2">Don't have an account ? <span className="text-blue-400"><Link href={"/signUp"}>Register</Link></span></p>
        </div>
    );
};
